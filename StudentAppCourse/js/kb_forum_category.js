...
//获取头像
var portrait = common.getPublicItem("sessionStaff")["portrait"];
...
function getForumCategoryList(){
	...
	var staffId = common.getPublicItem("sessionStaff")["staffId"];
	var sessionId = common.getPublicItem("sessionId");
	mui.ajax(common.SERVICE_PREFIX_ADDRESS+"forum/queryCategoryForPage.do",{
...
var subpages = ['forum_recommend_post.html', 'forum_hot_post.html', 'forum_learn_garden.html', 'questionnaire_list.html'];
// 页面ID
// 屏蔽应急咨询版块
// var subpagesIds = ['forum_recommend_post', 'forum_hot_post', 'forum_learn_garden', 'questionnaire_list', 'emergency_forum_post_list'];
var subpagesIds = ['forum_recommend_post', 'forum_hot_post','forum_learn_garden','questionnaire_list'];
