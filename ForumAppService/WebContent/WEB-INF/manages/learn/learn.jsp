...
<html lang="cn">
	<head>
		<meta charset="utf-8" />
		<title>控制台 - 论坛App控制台-知识学习配置</title>
	...
	<body>
							...
							<div class="col-xs-12">
														...
														<div class="row">
															<div class="col-xs-12 col-sm-9">
																<div class="input-group">
																	<input id="qKbTitle" type="text" class="form-control search-query" placeholder="请输入知识标题名称" />
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div id="kb_info" class="easyui-window" title="知识学习信息" closed="true" style="width:800px; height:550px; left:155px; top:0px; padding:4px;">
											<div class="row" style="margin-left:0px;margin-right:0px;">
												<div class="col-xs-12">
													<form class="form-horizontal" role="form" id="form1" method="post" action="${baseurl}/manages/learn/saveKb.do">
														<div class="form-group">
															<label class="col-sm-2 control-label no-padding-right" for="kbTitle">知识标题</label>

															<div class="col-sm-10">
																<input type="hidden" id="userId" name="userId"/>
																<input type="hidden" id="kbId" name="kbId"/>
																<input type="text" id="kbTitle" name="kbTitle" placeholder="知识标题" class="col-xs-10 col-sm-5 required" maxlength="50" />
															</div>
														</div>
														<div class="form-group">
															<label class="col-sm-2 control-label no-padding-right" for="content">知识描述</label>
															<div class="col-sm-10">
																<textarea id="content" name="content" rows="4" class="col-xs-10 col-sm-8 required" placeholder="知识描述" maxlength="200"></textarea>
															</div>
														</div>
														
														<div class="form-group">
															<label class="col-sm-2 control-label no-padding-right" for="kbLink">知识链接</label>
															<div class="col-sm-10">
																<input id="kbLink" name="kbLink" rows="4" type="url" class="col-xs-10 col-sm-8 required" placeholder="知识链接" maxlength="200"></input>
															</div>
														</div>
														
														<div class="form-group">
															<label class="col-sm-2 control-label no-padding-right" for="createDate">知识发布时间</label>
															
															<div class="col-sm-10">
																<input type="text" id="createDate" name="createDate" placeholder="知识发布时间" class="col-xs-10 col-sm-5 date-picker required" data-date-format="yyyy-mm-dd" />
															</div>
														</div>
														
														<div class="form-group">
															<label class="col-sm-2 control-label no-padding-right" for="updateDate">知识结束时间</label>
															
															<div class="col-sm-10">
																<input type="text" id="updateDate" name="updateDate" placeholder="知识结束时间" class="col-xs-10 col-sm-5 date-picker required" data-date-format="yyyy-mm-dd" />
															</div>
														</div>
														<div class="row">
															<div class="col-xs-12">
										...
										<table id="kb_learn-grid" title="知识学习列表" class="easyui-datagrid" style="height:350px;" rownumbers="true" pagination="true" toolbar="#toolbar">
											<thead>
												<tr>
													<th field="kbTitle" width="80px">知识名称</th>
													<th field="kbLink" width="80px">链接地址</th>
													<th field="content" width="80px">知识描述</th>
													<th field="type" width="80px">类型</th>
													<th field="createDate" width="60px">知识发布时间</th>
													<th field="updateDate" width="60px">知识结束时间</th>
		...
		<script type="text/javascript" src="${baseurl}/assets/js/app/learn.js"></script>
		<script type="text/javascript">
		    var baseurl = "${baseurl}";
